...
private struct SafeModeLaunchRoot: View {
    ...
    var body: some View {
        ContentView(
            ...
            settingsBackendContextProvider: { container.settingsBackendContext },
            runBackendConnectionTest: { await container.runBackendConnectionTest() },
            runProfileSyncTest: { await container.runProfileSyncTest() },
            runCommunitySyncTest: { await container.runCommunitySyncTest() },
            runDMSyncTest: { await container.runDMSyncTest() },
